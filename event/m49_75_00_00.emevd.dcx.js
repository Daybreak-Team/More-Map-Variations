...
$Event(0, Default, function() {
    ...
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065144, 49750820, 49750830, 49750840, 49750850, 49750860, 49750870, 49750880, 49750890, 49755210, 49750200, 49750800, 49750206);
    }
    if (IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065145, 49750820, 49750830, 49750840, 49750850, 49750860, 49750870, 49750880, 49750890, 49755210, 49750200, 49750800, 49750206, 49750207);
    }
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015002, 0, 49750200, 49750800, 49755210, 1020, 772000, 110320, 140001, 49750800);
    ...
    if (IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90015475, 49752200, 49750800);
        $InitializeCommonEvent(0, 90015475, 49752200, 0);
        $InitializeCommonEvent(0, 90015475, 49752200, 0);
    }
    $InitializeCommonEvent(0, 90035001, 49750800);
    if (2 == 1) {
