...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 9005810, 46515810, 46510500, 46511500, 5);
...
S0:
    ...
    $InitializeCommonEvent(0, 90015008, 0, 46515810, 920910, 46515810, 0, 0);
    $InitializeCommonEvent(0, 90015008, 0, 46515820, 920910, 46515820, 0, 0);
    $InitializeCommonEvent(0, 90015008, 0, 46515830, 920910, 46515830, 0, 0);
    $InitializeCommonEvent(0, 90015008, 0, 46515840, 920910, 46515840, 0, 0);
