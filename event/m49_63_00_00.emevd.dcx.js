...
$Event(0, Default, function() {
    ...
    $InitializeCommonEvent(0, 90065910, 49630200, 49632205, 49630800, 950000, 690047, 49630800, 49630800, 904974000, 0, 0, 0, 0);
    $InitializeCommonEvent(0, 90065911, 49630200, 49630800, 950000, 49630800, 49630800, 904974000, 0, 0, 0, 0, 0);
    if (!IsMapVariation(2)) {
        $InitializeCommonEvent(0, 90065900, 49630800, 2, 0, 0, 1050, 950000, 904974000, 49630800);
    }
    $InitializeCommonEvent(0, 90015012, 49630800, 49630200);
    $InitializeCommonEvent(0, 90015020, 49630200, 49630800);
    $InitializeCommonEvent(0, 90015008, 49632205, 49630800, 950000, 49630800, 16230, 0);
    ...
    if (IsMapVariation(2)) {
        ...
        $InitializeCommonEvent(0, 90015030, 49630200, 49630800, 40, 950000, 0);
        $InitializeCommonEvent(0, 90015002, 0, 49630200, 49630800, 49630800, 1020, 950000, 110320, 904974000, 49630800);
